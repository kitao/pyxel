...
Веб-версия Pyxel может использоваться на ПК, а также на смартфонах и планшетах, при условии наличия совместимого веб-браузера, без установки Python или Pyxel.
