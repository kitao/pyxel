...
Если вышеописанная команда не работает, попробуйте собрать Pyxel из исходного кода, следуя инструкциям в [Makefile](../Makefile).
...
<td>Первая победная игра Pyxel Jam от <a href="https://x.com/helpcomputer0">Adam</a></td>
...
<td>Аркадная игра с физикой мяча, созданная <a href="https://x.com/helpcomputer0">Adam</a></td>
...
- `set(seq0, seq1, seq2, ...)`<br>
  Установить списки звуков (0-63) для каждого канала. Если указан пустой список, этот канал не используется для воспроизведения.<br>
  Пример: `pyxel.musics[0].set([0, 1], [], [3])`

### Расширенный APIs

Pyxel включает «расширенные API», не упомянутые в этом документе, так как они «могут смутить пользователя» или «требуют специальных знаний для использования».
