...
**Примечание:** В Windows при установке Python убедитесь, что вы отметили `Add python.exe to PATH`, чтобы активировать команду `pyxel`.

### Web

Веб-версию Pyxel можно использовать без установки на ПК, смартфонах, планшетах и других устройствах с совместимым браузером.

Веб-среда разработки [Pyxel Code Maker](https://kitao.github.io/pyxel/wasm/code-maker/) готова к использованию — просто откройте её в браузере.

Для других вариантов использования, таких как встраивание приложений Pyxel на ваш собственный сайт, обратитесь к [этой странице](pyxel-web-en.md).

### VS Code

Добавив расширение Pyxel в [Visual Studio Code](https://code.visualstudio.com/) (VS Code), вы можете разрабатывать и запускать приложения Pyxel без установки Python или Pyxel.

Чтобы добавить расширение Pyxel, найдите «[Pyxel](https://marketplace.visualstudio.com/items?itemName=kitao.pyxel-vscode)» в представлении расширений VS Code и нажмите кнопку установки.
...
Подробные инструкции см. в [Руководстве по Pyxel Editor](https://kitao.github.io/pyxel/wasm/editor-manual/).
...
Полный список API Pyxel доступен на странице [Справочник API Pyxel](https://kitao.github.io/pyxel/wasm/api-reference/).
...
- [Справочник API Pyxel](https://kitao.github.io/pyxel/wasm/api-reference/)
- [Руководство по Pyxel Editor](https://kitao.github.io/pyxel/wasm/editor-manual/)
...
- [Расширение для VS Code](https://marketplace.visualstudio.com/items?itemName=kitao.pyxel-vscode)
- [MCP-сервер](https://github.com/kitao/pyxel-mcp)
- [Навык для Claude Code](https://github.com/kitao/pyxel-skill)
