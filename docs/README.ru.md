...
Для других вариантов использования, таких как встраивание приложений Pyxel на ваш собственный сайт, обратитесь к [этой странице](pyxel-web-ru.md).
...
- [Расширение Pyxel для VS Code](https://marketplace.visualstudio.com/items?itemName=kitao.pyxel-vscode)
- [Pyxel MCP-сервер](https://github.com/kitao/pyxel-mcp)
- [Навык Pyxel для Claude Code](https://github.com/kitao/pyxel-skill)
