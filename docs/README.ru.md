...
Перетаскивая TMX-файл (Tiled Map File) на экран редактора плиток и удерживая при этом цифровую клавишу, можно загрузить соответствующий слой в текущую выбранную плиточную карту.
...
- `load(x, y, filename, layer)`<br>
  Загрузите слой с указанным номером индекса из файла TMX (Tiled Map File) по адресу (`x`, `y`).
