...
С помощью [расширения Pyxel для Visual Studio Code](https://marketplace.visualstudio.com/items?itemName=kitao.pyxel-vscode) вы можете запускать и разрабатывать приложения Pyxel в VS Code без установки Python или Pyxel.
