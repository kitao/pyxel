...
タイルマップエディタ画面に TMX ファイル (Tiled Map File) を数字キーを押しながらドラッグ＆ドロップすると、指定されたインデックス番号のレイヤーをタイルマップに読み込むことができます。
...
- `load(x, y, filename, layer)`<br>
  (`x`, `y`) に TMX ファイル (Tiled Map File) の指定されたインデックス番号のレイヤーを読み込みます。
