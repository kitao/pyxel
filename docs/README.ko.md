...
[Pyxel Visual Studio Code 확장](https://marketplace.visualstudio.com/items?itemName=kitao.pyxel-vscode)을 사용하면 Python이나 Pyxel을 설치하지 않고도 VS Code에서 Pyxel 앱을 실행하고 개발할 수 있습니다.
