...
Ao arrastar e largar um ficheiro TMX (Tiled Map File) no ecrã do Tilemap Editor, a camada correspondente ao número do mapa de azulejos atualmente selecionado.
