...
Se você utiliza Python3, que é instalado por padrão no Mac, por favor adicione `sudo` ao início do comando acima para habilitar o comando pyxel.
...
<td>Jogo de física de bola arcade por Adam</td>
