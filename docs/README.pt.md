...
- [01_hello_pyxel.py](../python/pyxel/examples/01_hello_pyxel.py) - Aplicação simples
- [02_jump_game.py](../python/pyxel/examples/02_jump_game.py) - Jogo de pulo com o arquivo de recursos do Pyxel
- [03_draw_api.py](../python/pyxel/examples/03_draw_api.py) - Demonstração das APIs de desenho
- [04_sound_api.py](../python/pyxel/examples/04_sound_api.py) - Demonstração das APIs de som
- [05_color_palette.py](../python/pyxel/examples/05_color_palette.py) - Lista da paleta de cores
- [06_click_game.py](../python/pyxel/examples/06_click_game.py) - Jogo de clique com mouse
- [07_snake.py](../python/pyxel/examples/07_snake.py) - Jogo Snake com BGM
- [08_triangle_api.py](../python/pyxel/examples/08_triangle_api.py) - Demonstração da API de desenho de triângulos
- [09_shooter.py](../python/pyxel/examples/09_shooter.py) - Jogo de tiro com transição de tela
- [10_platformer.py](../python/pyxel/examples/10_platformer.py) - Jogo side-scrolling de plataforma com mapa
- [11_offscreen.py](../python/pyxel/examples/11_offscreen.py) - Renderização fora do ecrã com classe de Image
- [12_perlin_noise.py](../python/pyxel/examples/12_perlin_noise.py) - Animação sonora Perlin
