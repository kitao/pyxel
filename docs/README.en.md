# <img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/pyxel_logo_152x64.png">
...
[ [English](https://github.com/kitao/pyxel/blob/main/.github/README.md) | [中文](https://github.com/kitao/pyxel/blob/main/.github/../docs/README.cn.md) | [Deutsch](https://github.com/kitao/pyxel/blob/main/.github/../docs/README.de.md) | [Español](https://github.com/kitao/pyxel/blob/main/.github/../docs/README.es.md) | [Français](https://github.com/kitao/pyxel/blob/main/.github/../docs/README.fr.md) | [Italiano](https://github.com/kitao/pyxel/blob/main/.github/../docs/README.it.md) | [日本語](https://github.com/kitao/pyxel/blob/main/.github/../docs/README.ja.md) | [한국어](https://github.com/kitao/pyxel/blob/main/.github/../docs/README.ko.md) | [Português](https://github.com/kitao/pyxel/blob/main/.github/../docs/README.pt.md) | [Русский](https://github.com/kitao/pyxel/blob/main/.github/../docs/README.ru.md) ]
...
<p>
<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/01_hello_pyxel.gif" width="320">
<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/02_jump_game.gif" width="320">
<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/03_draw_api.gif" width="320">
<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/04_sound_api.gif" width="320">
<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/image_tilemap_editor.gif" width="320">
<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/sound_music_editor.gif" width="320">
</p>
...
<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/05_color_palette.png">

<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/pyxel_palette.png">
...
If the above doesn't work, try self-building according to the instructions in [Makefile](https://github.com/kitao/pyxel/blob/main/.github/Makefile).
...
- [01_hello_pyxel.py](https://github.com/kitao/pyxel/blob/main/.github/pyxel/examples/01_hello_pyxel.py) - Simplest application
- [02_jump_game.py](https://github.com/kitao/pyxel/blob/main/.github/pyxel/examples/02_jump_game.py) - Jump game with Pyxel resource file
- [03_draw_api.py](https://github.com/kitao/pyxel/blob/main/.github/pyxel/examples/03_draw_api.py) - Demonstration of drawing APIs
- [04_sound_api.py](https://github.com/kitao/pyxel/blob/main/.github/pyxel/examples/04_sound_api.py) - Demonstration of sound APIs
- [05_color_palette.py](https://github.com/kitao/pyxel/blob/main/.github/pyxel/examples/05_color_palette.py) - Color palette list
- [06_click_game.py](https://github.com/kitao/pyxel/blob/main/.github/pyxel/examples/06_click_game.py) - Mouse click game
- [07_snake.py](https://github.com/kitao/pyxel/blob/main/.github/pyxel/examples/07_snake.py) - Snake game with BGM
- [08_triangle_api.py](https://github.com/kitao/pyxel/blob/main/.github/pyxel/examples/08_triangle_api.py) - Demonstration of triangle drawing APIs
- [09_shooter.py](https://github.com/kitao/pyxel/blob/main/.github/pyxel/examples/09_shooter.py) - Shoot'em up game with screen transition
- [10_platformer.py](https://github.com/kitao/pyxel/blob/main/.github/pyxel/examples/10_platformer.py) - Side-scrolling platform game with map
- [11_offscreen.py](https://github.com/kitao/pyxel/blob/main/.github/pyxel/examples/11_offscreen.py) - Offscreen rendering with Image class
- [12_perlin_noise.py](https://github.com/kitao/pyxel/blob/main/.github/pyxel/examples/12_perlin_noise.py) - Perlin noise animation
- [30SecondsOfDaylight.pyxapp](https://github.com/kitao/pyxel/blob/main/.github/../docs/images/30SecondsOfDaylight.gif) - 1st Pyxel Jam winning game by [Adam](https://twitter.com/helpcomputer0)
- [megaball.pyxapp](https://github.com/kitao/pyxel/blob/main/.github/../docs/images/megaball.gif) - Arcade ball physics game by [Adam](https://twitter.com/helpcomputer0)
...
<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/image_editor.gif">
...
<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/tilemap_editor.gif">

**Sound Editor:**

The mode to edit sounds.

<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/sound_editor.gif">

**Music Editor:**

The mode to edit musics in which the sounds are arranged in order of playback.

<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/music_editor.gif">
...
- `btn(key)`<br>
Return `True` if `key` is pressed, otherwise return `False`. ([Key definition list](https://github.com/kitao/pyxel/blob/main/.github/pyxel/__init__.pyi))
...
<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/blt_figure.png">
...
<img src="https://raw.githubusercontent.com/kitao/pyxel/main/.github/../docs/images/bltm_figure.png">
...
If you are familiar with your skills, try to create amazing works with [this](https://github.com/kitao/pyxel/blob/main/.github/pyxel/__init__.pyi) as a clue!
...
Submitted pull request is deemed to have agreed to publish under [MIT License](https://github.com/kitao/pyxel/blob/main/.github/LICENSE).
...
Pyxel is under [MIT License](https://github.com/kitao/pyxel/blob/main/.github/LICENSE). It can be reused within proprietary software, provided that all copies of the software or its substantial portions include a copy of the terms of the MIT License and also a copyright notice.
