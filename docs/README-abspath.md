...
If the above command doesn't work, try building Pyxel from source by following the instructions in the [Makefile](https://github.com/kitao/pyxel/blob/main//Makefile).
...
For specific instructions, please refer to [this page](https://github.com/kitao/pyxel/blob/main//docs/pyxel-web-en.md).
...
By submitting a pull request, you agree to publish your contribution under the [MIT License](https://github.com/kitao/pyxel/blob/main//LICENSE).
