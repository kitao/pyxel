...
Завдяки своїм простим специфікаціям, натхненними ретро-ігровими консолями (таким як можливість відображення лише 16 кольорів та відтворення лише 4 звуків одночасно), ви можете сміливо насолоджуватися створенням ігор у стилі піксель-арт.
...
Після інсталяції [Python3](https://www.python.org/) (версії 3.7 або вище), виконайте наступну команду:
...
Після інсталяції пакету SDL2 (`libsdl2-dev` для Ubuntu), [Python3](https://www.python.org/) (версії 3.7 або вище), та `python3-pip`, виконайте наступну команду:
...
Для отримання конкретних вказівок, будь ласка, зверніться до [this page](https://github.com/kitao/pyxel/wiki/How-To-Use-Pyxel-Web).
...
<td><a href="https://kitao.github.io/pyxel/wasm/examples/03_draw_api.html">Демо</a></td>
...
<td><a href="https://kitao.github.io/pyxel/wasm/examples/04_sound_api.html">Демо</a></td>
...
<td><a href="https://kitao.github.io/pyxel/wasm/examples/05_color_palette.html">Демо</a></td>
...
<td><a href="https://kitao.github.io/pyxel/wasm/examples/06_click_game.html">Демо</a></td>
...
<td><a href="https://kitao.github.io/pyxel/wasm/examples/07_snake.html">Демо</a></td>
...
<td><a href="https://kitao.github.io/pyxel/wasm/examples/08_triangle_api.html">Демо</a></td>
...
<td><a href="https://kitao.github.io/pyxel/wasm/examples/09_shooter.html">Демо</a></td>
...
<td><a href="https://kitao.github.io/pyxel/wasm/examples/10_platformer.html">Демо</a></td>
...
<td><a href="https://kitao.github.io/pyxel/wasm/examples/11_offscreen.html">Демо</a></td>
...
<td><a href="https://kitao.github.io/pyxel/wasm/examples/12_perlin_noise.html">Демо</a></td>
...
<td><a href="https://kitao.github.io/pyxel/wasm/examples/13_bitmap_font.html">Демо</a></td>
...
<td><a href="https://kitao.github.io/pyxel/wasm/examples/14_synthesizer.html">Демо</a></td>
...
<td><a href="https://kitao.github.io/pyxel/wasm/examples/15_tiled_map_file.html">Демо</a></td>
...
<td><a href="https://github.com/kitao/pyxel/blob/main/docs/images/99_flip_animation.gif">Демо</a></td>
...
Створений скрипт Python можна запустити за допомогою наступної команди:

```sh
pyxel run PYTHON_SCRIPT_FILE
```

Він також може бути виконаний як звичайний скрипт Python:
...
Під час роботи програми Pyxel можна використати наступні спеціальні клавіші керування:
...
Створіть файл програми Pyxel (.pyxapp) за допомогою наступної команди:
...
Створений файл програми можна запустити за допомогою наступної команди:
...
- [Твіттер акаунт розробника](https://twitter.com/kitao)
