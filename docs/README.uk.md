...
Для інших варіантів використання, таких як вбудовування додатків Pyxel на ваш власний сайт, зверніться до [цієї сторінки](pyxel-web-en.md).
...
Повний список API Pyxel доступний на сторінці [Довідник API Pyxel](https://kitao.github.io/pyxel/wasm/api-reference/).
...
- [Довідник API Pyxel](https://kitao.github.io/pyxel/wasm/api-reference/)
- [Посібник з Pyxel Editor](https://kitao.github.io/pyxel/wasm/editor-manual/)
...
- [Розширення для VS Code](https://marketplace.visualstudio.com/items?itemName=kitao.pyxel-vscode)
- [MCP-сервер](https://github.com/kitao/pyxel-mcp)
- [Навичка для Claude Code](https://github.com/kitao/pyxel-skill)
