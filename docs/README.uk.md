...
- [Розширення Pyxel для VS Code](https://marketplace.visualstudio.com/items?itemName=kitao.pyxel-vscode)
- [Pyxel MCP-сервер](https://github.com/kitao/pyxel-mcp)
- [Навичка Pyxel для Claude Code](https://github.com/kitao/pyxel-skill)
