...
Режим для редагування тайлових карт, де зображення з банків зображень розташовані в плитковому шаблоні.

<a href="https://kitao.github.io/pyxel/wasm/examples/tilemap_editor.html">
<img src="images/tilemap_editor.gif">
</a>

Перетягніть файл TMX (Tiled Map File) на редактор тайлів, щоб завантажити його шар у порядку малювання, що відповідає поточному вибраному номеру тайлової карти.
...
Зображення та тайлові карти Pyxel також можна створювати за допомогою таких методів:
...
- `images`<br>
  Список банків зображень (0-2)<br>
...
- `musics`<br>
  Список музичних композицій (0-7)
