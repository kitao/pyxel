...
**Pyxel** – це ретро-ігровий двигун для Python.

Завдяки простим специфікаціям, натхненним ретро-ігровими консолями, таким як відображення лише 16 кольорів і відтворення лише 4 звуків одночасно, ви можете з легкістю насолоджуватися створенням ігор у стилі піксель-арт.
...
Pyxel має відкритий вихідний код під [ліцензією MIT](../LICENSE) і є вільним для використання. Почнемо створювати ретро-ігри за допомогою Pyxel!
...
- 3 банки зображень розміром 256x256 пікселів
...
- Розширення кольорів, палітр, каналів та банків користувачем
...
- `musics`<br>
  Список музики (0-7). (Див. клас Music)
