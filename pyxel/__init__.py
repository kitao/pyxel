...
COLOR_DARKBLUE: int = _get_constant_number("COLOR_DARKBLUE")
COLOR_LIGHTBLUE: int = _get_constant_number("COLOR_LIGHTBLUE")
...
COLOR_GRAY: int = _get_constant_number("COLOR_GRAY")
