...
PYXEL_API void Timemap_set(void *self, int x, int y, int *data, int data_width,
                           int data_height, int refimg);
PYXEL_API void Timemap_copy(void *self, int x, int y, int tm, int u, int v,
                            int w, int h);
...
PYXEL_API void Music_set(void *msc, int *ch0, int ch0_length, int *ch1,
