...
#define PICO8_COLOR 1
#define SEPIA_COLOR 2
#define FILTER_COLOR 3
#define PYXEL_PALETTE FILTER_COLOR
...
const std::array<int32_t, COLOR_COUNT> DEFAULT_PALETTE = {
    ...
    0xA9C1FF, 0xFFFFFF, 0xD4186C, 0xDD996E, 0xEECF5D, 0x70C6A9,
