...
inline int32_t Oscillator::Triangle(int32_t period, int32_t phase) {
...
inline int32_t Oscillator::Square(int32_t period, int32_t phase) {
...
inline int32_t Oscillator::Pulse(int32_t period, int32_t phase) {
  float x = static_cast<float>(phase) / period;
  x -= static_cast<int32_t>(x);
...
inline int32_t Oscillator::Noise(int32_t period, int32_t phase) {
  if (phase % (period / 4) == 0) {
    noise_seed_ >>= 1;
