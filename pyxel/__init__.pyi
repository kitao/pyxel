...
def clip2(x1: float, y1: float, x2: float, y2: float) -> None: ...
def camera(
    x: Optional[float] = None,
    y: Optional[float] = None,
) -> None: ...
...
def rect2(x1: float, y1: float, x2: float, y2: float, col: int) -> None: ...
def rectb(x: float, y: float, w: float, h: float, col: int) -> None: ...
def rectb2(x1: float, y1: float, x2: float, y2: float, col: int) -> None: ...
...
def elli2(x1: float, y1: float, x2: float, y2: float, col: int) -> None: ...
def ellib(self, x: float, y: float, w: float, h: float, col: int) -> None: ...
def ellib2(x1: float, y1: float, x2: float, y2: float, col: int) -> None: ...
def tri(
    x1: float,
    y1: float,
    x2: float,
...
class Image:
    ...
    def clip2(self, x1: float, y1: float, x2: float, y2: float) -> None: ...
    def camera(
        self,
        x: Optional[float] = None,
        y: Optional[float] = None,
    ...
    def rect2(self, x1: float, y1: float, x2: float, y2: float, col: int) -> None: ...
    def rectb(self, x: float, y: float, w: float, h: float, col: int) -> None: ...
    def rectb2(self, x1: float, y1: float, x2: float, y2: float, col: int) -> None: ...
    def circ(self, x: float, y: float, r: float, col: int) -> None: ...
    def circb(self, x: float, y: float, r: float, col: int) -> None: ...
    def elli(self, x: float, y: float, w: float, h: float, col: int) -> None: ...
    def elli2(self, x1: float, y1: float, x2: float, y2: float, col: int) -> None: ...
    def ellib(self, x: float, y: float, w: float, h: float, col: int) -> None: ...
    def ellib2(self, x1: float, y1: float, x2: float, y2: float, col: int) -> None: ...
    def tri(
...
class Tilemap:
    ...
    def fill(x: float, y: float, tile: Tuple[int, int]) -> None: ...
    def blt(
        self,
        x: float,
        y: float,
