...
def ellip(self, x: float, y: float, w: float, h: float, col: int) -> None: ...
def ellipb(self, x: float, y: float, w: float, h: float, col: int) -> None: ...
def tri(
    x1: float,
    y1: float,
    x2: float,
...
class Tilemap:
    ...
    def ellip(self, x: float, y: float, w: float, h: float, tile: Tuple[int, int]) -> None: ...
    def ellipb(self, x: float, y: float, w: float, h: float, tile: Tuple[int, int]) -> None: ...
    def tri(
        self,
        x1: float,
        y1: float,
