...
impl Model {
    ...
    pub fn tex_cube(img: u32, u: f32, v: f32, w: f32, h: f32) -> Self {
        let v8 = [
    ...
    pub fn tex_pyramid(img: u32, u: f32, v: f32, w: f32, h: f32) -> Self {
        let base = [
            Vec3::new(-0.5, -0.5, -0.5),
            Vec3::new(0.5, -0.5, -0.5),
            Vec3::new(0.5, 0.5, -0.5),
    ...
    pub fn tex_sphere(img: u32, u: f32, v: f32, w: f32, h: f32) -> Self {
        let t = f32::midpoint(1.0, 5.0_f32.sqrt());
        let n = (1.0 + t * t).sqrt();
        let va = 1.0 / n * 0.5;
        let vb = t / n * 0.5;
