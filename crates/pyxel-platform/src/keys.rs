...
// Gamepad1
pub const GAMEPAD1_KEY_START_INDEX: Key = 12000;
pub const GAMEPAD_KEY_INDEX_INTERVAL: Key = 1000;
pub const GAMEPAD1_AXIS_LEFTX: Key = GAMEPAD1_KEY_START_INDEX + 0;
pub const GAMEPAD1_AXIS_LEFTY: Key = GAMEPAD1_KEY_START_INDEX + 1;
pub const GAMEPAD1_AXIS_RIGHTX: Key = GAMEPAD1_KEY_START_INDEX + 2;
pub const GAMEPAD1_AXIS_RIGHTY: Key = GAMEPAD1_KEY_START_INDEX + 3;
pub const GAMEPAD1_AXIS_TRIGGERLEFT: Key = GAMEPAD1_KEY_START_INDEX + 4;
pub const GAMEPAD1_AXIS_TRIGGERRIGHT: Key = GAMEPAD1_KEY_START_INDEX + 5;
pub const GAMEPAD1_BUTTON_A: Key = GAMEPAD1_KEY_START_INDEX + 6;
pub const GAMEPAD1_BUTTON_B: Key = GAMEPAD1_KEY_START_INDEX + 7;
pub const GAMEPAD1_BUTTON_X: Key = GAMEPAD1_KEY_START_INDEX + 8;
pub const GAMEPAD1_BUTTON_Y: Key = GAMEPAD1_KEY_START_INDEX + 9;
pub const GAMEPAD1_BUTTON_BACK: Key = GAMEPAD1_KEY_START_INDEX + 10;
pub const GAMEPAD1_BUTTON_GUIDE: Key = GAMEPAD1_KEY_START_INDEX + 11;
pub const GAMEPAD1_BUTTON_START: Key = GAMEPAD1_KEY_START_INDEX + 12;
pub const GAMEPAD1_BUTTON_LEFTSTICK: Key = GAMEPAD1_KEY_START_INDEX + 13;
pub const GAMEPAD1_BUTTON_RIGHTSTICK: Key = GAMEPAD1_KEY_START_INDEX + 14;
pub const GAMEPAD1_BUTTON_LEFTSHOULDER: Key = GAMEPAD1_KEY_START_INDEX + 15;
pub const GAMEPAD1_BUTTON_RIGHTSHOULDER: Key = GAMEPAD1_KEY_START_INDEX + 16;
pub const GAMEPAD1_BUTTON_DPAD_UP: Key = GAMEPAD1_KEY_START_INDEX + 17;
pub const GAMEPAD1_BUTTON_DPAD_DOWN: Key = GAMEPAD1_KEY_START_INDEX + 18;
pub const GAMEPAD1_BUTTON_DPAD_LEFT: Key = GAMEPAD1_KEY_START_INDEX + 19;
pub const GAMEPAD1_BUTTON_DPAD_RIGHT: Key = GAMEPAD1_KEY_START_INDEX + 20;
pub const GAMEPAD1_BUTTON_MISC1: Key = GAMEPAD1_KEY_START_INDEX + 21;
pub const GAMEPAD1_BUTTON_PADDLE1: Key = GAMEPAD1_KEY_START_INDEX + 22;
pub const GAMEPAD1_BUTTON_PADDLE2: Key = GAMEPAD1_KEY_START_INDEX + 23;
pub const GAMEPAD1_BUTTON_PADDLE3: Key = GAMEPAD1_KEY_START_INDEX + 24;
pub const GAMEPAD1_BUTTON_PADDLE4: Key = GAMEPAD1_KEY_START_INDEX + 25;
pub const GAMEPAD1_BUTTON_TOUCHPAD: Key = GAMEPAD1_KEY_START_INDEX + 26;

// Gamepad2
pub const GAMEPAD2_KEY_START_INDEX: Key = GAMEPAD1_KEY_START_INDEX + GAMEPAD_KEY_INDEX_INTERVAL;
pub const GAMEPAD2_AXIS_LEFTX: Key = GAMEPAD2_KEY_START_INDEX + 0;
pub const GAMEPAD2_AXIS_LEFTY: Key = GAMEPAD2_KEY_START_INDEX + 1;
pub const GAMEPAD2_AXIS_RIGHTX: Key = GAMEPAD2_KEY_START_INDEX + 2;
pub const GAMEPAD2_AXIS_RIGHTY: Key = GAMEPAD2_KEY_START_INDEX + 3;
pub const GAMEPAD2_AXIS_TRIGGERLEFT: Key = GAMEPAD2_KEY_START_INDEX + 4;
pub const GAMEPAD2_AXIS_TRIGGERRIGHT: Key = GAMEPAD2_KEY_START_INDEX + 5;
pub const GAMEPAD2_BUTTON_A: Key = GAMEPAD2_KEY_START_INDEX + 6;
pub const GAMEPAD2_BUTTON_B: Key = GAMEPAD2_KEY_START_INDEX + 7;
pub const GAMEPAD2_BUTTON_X: Key = GAMEPAD2_KEY_START_INDEX + 8;
pub const GAMEPAD2_BUTTON_Y: Key = GAMEPAD2_KEY_START_INDEX + 9;
pub const GAMEPAD2_BUTTON_BACK: Key = GAMEPAD2_KEY_START_INDEX + 10;
pub const GAMEPAD2_BUTTON_GUIDE: Key = GAMEPAD2_KEY_START_INDEX + 11;
pub const GAMEPAD2_BUTTON_START: Key = GAMEPAD2_KEY_START_INDEX + 12;
pub const GAMEPAD2_BUTTON_LEFTSTICK: Key = GAMEPAD2_KEY_START_INDEX + 13;
pub const GAMEPAD2_BUTTON_RIGHTSTICK: Key = GAMEPAD2_KEY_START_INDEX + 14;
pub const GAMEPAD2_BUTTON_LEFTSHOULDER: Key = GAMEPAD2_KEY_START_INDEX + 15;
pub const GAMEPAD2_BUTTON_RIGHTSHOULDER: Key = GAMEPAD2_KEY_START_INDEX + 16;
pub const GAMEPAD2_BUTTON_DPAD_UP: Key = GAMEPAD2_KEY_START_INDEX + 17;
pub const GAMEPAD2_BUTTON_DPAD_DOWN: Key = GAMEPAD2_KEY_START_INDEX + 18;
pub const GAMEPAD2_BUTTON_DPAD_LEFT: Key = GAMEPAD2_KEY_START_INDEX + 19;
pub const GAMEPAD2_BUTTON_DPAD_RIGHT: Key = GAMEPAD2_KEY_START_INDEX + 20;
pub const GAMEPAD2_BUTTON_MISC1: Key = GAMEPAD2_KEY_START_INDEX + 21;
pub const GAMEPAD2_BUTTON_PADDLE1: Key = GAMEPAD2_KEY_START_INDEX + 22;
pub const GAMEPAD2_BUTTON_PADDLE2: Key = GAMEPAD2_KEY_START_INDEX + 23;
pub const GAMEPAD2_BUTTON_PADDLE3: Key = GAMEPAD2_KEY_START_INDEX + 24;
pub const GAMEPAD2_BUTTON_PADDLE4: Key = GAMEPAD2_KEY_START_INDEX + 25;
pub const GAMEPAD2_BUTTON_TOUCHPAD: Key = GAMEPAD2_KEY_START_INDEX + 26;

// Gamepad3
pub const GAMEPAD3_KEY_START_INDEX: Key = GAMEPAD1_KEY_START_INDEX + GAMEPAD_KEY_INDEX_INTERVAL * 2;
pub const GAMEPAD3_AXIS_LEFTX: Key = GAMEPAD3_KEY_START_INDEX + 0;
pub const GAMEPAD3_AXIS_LEFTY: Key = GAMEPAD3_KEY_START_INDEX + 1;
pub const GAMEPAD3_AXIS_RIGHTX: Key = GAMEPAD3_KEY_START_INDEX + 2;
pub const GAMEPAD3_AXIS_RIGHTY: Key = GAMEPAD3_KEY_START_INDEX + 3;
pub const GAMEPAD3_AXIS_TRIGGERLEFT: Key = GAMEPAD3_KEY_START_INDEX + 4;
pub const GAMEPAD3_AXIS_TRIGGERRIGHT: Key = GAMEPAD3_KEY_START_INDEX + 5;
pub const GAMEPAD3_BUTTON_A: Key = GAMEPAD3_KEY_START_INDEX + 6;
pub const GAMEPAD3_BUTTON_B: Key = GAMEPAD3_KEY_START_INDEX + 7;
pub const GAMEPAD3_BUTTON_X: Key = GAMEPAD3_KEY_START_INDEX + 8;
pub const GAMEPAD3_BUTTON_Y: Key = GAMEPAD3_KEY_START_INDEX + 9;
pub const GAMEPAD3_BUTTON_BACK: Key = GAMEPAD3_KEY_START_INDEX + 10;
pub const GAMEPAD3_BUTTON_GUIDE: Key = GAMEPAD3_KEY_START_INDEX + 11;
pub const GAMEPAD3_BUTTON_START: Key = GAMEPAD3_KEY_START_INDEX + 12;
pub const GAMEPAD3_BUTTON_LEFTSTICK: Key = GAMEPAD3_KEY_START_INDEX + 13;
pub const GAMEPAD3_BUTTON_RIGHTSTICK: Key = GAMEPAD3_KEY_START_INDEX + 14;
pub const GAMEPAD3_BUTTON_LEFTSHOULDER: Key = GAMEPAD3_KEY_START_INDEX + 15;
pub const GAMEPAD3_BUTTON_RIGHTSHOULDER: Key = GAMEPAD3_KEY_START_INDEX + 16;
pub const GAMEPAD3_BUTTON_DPAD_UP: Key = GAMEPAD3_KEY_START_INDEX + 17;
pub const GAMEPAD3_BUTTON_DPAD_DOWN: Key = GAMEPAD3_KEY_START_INDEX + 18;
pub const GAMEPAD3_BUTTON_DPAD_LEFT: Key = GAMEPAD3_KEY_START_INDEX + 19;
pub const GAMEPAD3_BUTTON_DPAD_RIGHT: Key = GAMEPAD3_KEY_START_INDEX + 20;
pub const GAMEPAD3_BUTTON_MISC1: Key = GAMEPAD3_KEY_START_INDEX + 21;
pub const GAMEPAD3_BUTTON_PADDLE1: Key = GAMEPAD3_KEY_START_INDEX + 22;
pub const GAMEPAD3_BUTTON_PADDLE2: Key = GAMEPAD3_KEY_START_INDEX + 23;
pub const GAMEPAD3_BUTTON_PADDLE3: Key = GAMEPAD3_KEY_START_INDEX + 24;
pub const GAMEPAD3_BUTTON_PADDLE4: Key = GAMEPAD3_KEY_START_INDEX + 25;
pub const GAMEPAD3_BUTTON_TOUCHPAD: Key = GAMEPAD3_KEY_START_INDEX + 26;

// Gamepad4
pub const GAMEPAD4_KEY_START_INDEX: Key = GAMEPAD1_KEY_START_INDEX + GAMEPAD_KEY_INDEX_INTERVAL * 3;
pub const GAMEPAD4_AXIS_LEFTX: Key = GAMEPAD4_KEY_START_INDEX + 0;
pub const GAMEPAD4_AXIS_LEFTY: Key = GAMEPAD4_KEY_START_INDEX + 1;
pub const GAMEPAD4_AXIS_RIGHTX: Key = GAMEPAD4_KEY_START_INDEX + 2;
pub const GAMEPAD4_AXIS_RIGHTY: Key = GAMEPAD4_KEY_START_INDEX + 3;
pub const GAMEPAD4_AXIS_TRIGGERLEFT: Key = GAMEPAD4_KEY_START_INDEX + 4;
pub const GAMEPAD4_AXIS_TRIGGERRIGHT: Key = GAMEPAD4_KEY_START_INDEX + 5;
pub const GAMEPAD4_BUTTON_A: Key = GAMEPAD4_KEY_START_INDEX + 6;
pub const GAMEPAD4_BUTTON_B: Key = GAMEPAD4_KEY_START_INDEX + 7;
pub const GAMEPAD4_BUTTON_X: Key = GAMEPAD4_KEY_START_INDEX + 8;
pub const GAMEPAD4_BUTTON_Y: Key = GAMEPAD4_KEY_START_INDEX + 9;
pub const GAMEPAD4_BUTTON_BACK: Key = GAMEPAD4_KEY_START_INDEX + 10;
pub const GAMEPAD4_BUTTON_GUIDE: Key = GAMEPAD4_KEY_START_INDEX + 11;
pub const GAMEPAD4_BUTTON_START: Key = GAMEPAD4_KEY_START_INDEX + 12;
pub const GAMEPAD4_BUTTON_LEFTSTICK: Key = GAMEPAD4_KEY_START_INDEX + 13;
pub const GAMEPAD4_BUTTON_RIGHTSTICK: Key = GAMEPAD4_KEY_START_INDEX + 14;
pub const GAMEPAD4_BUTTON_LEFTSHOULDER: Key = GAMEPAD4_KEY_START_INDEX + 15;
pub const GAMEPAD4_BUTTON_RIGHTSHOULDER: Key = GAMEPAD4_KEY_START_INDEX + 16;
pub const GAMEPAD4_BUTTON_DPAD_UP: Key = GAMEPAD4_KEY_START_INDEX + 17;
...
pub const GAMEPAD4_BUTTON_MISC1: Key = GAMEPAD4_KEY_START_INDEX + 21;
pub const GAMEPAD4_BUTTON_PADDLE1: Key = GAMEPAD4_KEY_START_INDEX + 22;
pub const GAMEPAD4_BUTTON_PADDLE2: Key = GAMEPAD4_KEY_START_INDEX + 23;
pub const GAMEPAD4_BUTTON_PADDLE3: Key = GAMEPAD4_KEY_START_INDEX + 24;
pub const GAMEPAD4_BUTTON_PADDLE4: Key = GAMEPAD4_KEY_START_INDEX + 25;
pub const GAMEPAD4_BUTTON_TOUCHPAD: Key = GAMEPAD4_KEY_START_INDEX + 26;
