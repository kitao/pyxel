...
impl Image {
    ...
    pub fn ellip(&self, x: f64, y: f64, w: f64, h: f64, col: Color) {
        self.pyxel_image.lock().ellip(x, y, w, h, col);
    }

    pub fn ellipb(&self, x: f64, y: f64, w: f64, h: f64, col: Color) {
        self.pyxel_image.lock().ellipb(x, y, w, h, col);
    }
