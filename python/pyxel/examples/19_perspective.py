...
class App:
    ...
    def draw(self):
        ...
        hw = 99
        pyxel.blt3d(0, 16, hw, 134, 0, cam, rot, fov=self.fov)
        pyxel.bltm3d(hw + 2, 16, hw, 134, 0, cam, rot, fov=self.fov)

        # Divider
        pyxel.line(hw, 16, hw, 149, 0)
        pyxel.line(hw + 1, 16, hw + 1, 149, 0)

        # HUD
        pyxel.text(4, 2, "blt3d", 10)
        pyxel.text(hw + 6, 2, "bltm3d", 10)
        pyxel.text(4, 9, "WASD:Move Arrows:Look RF:Alt QE:Roll TG:FOV", 13)
