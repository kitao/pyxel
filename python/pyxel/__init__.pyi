...
class Image:
    ...
    def fget(self, tx: int, ty: int, bit: int) -> bool: ...
    def fset(self, tx: int, ty: int, bit: int, val: bool) -> None: ...
...
class Tilemap:
    ...
    def fget(self, x: float, y: float, bit: int) -> bool: ...
    def line(
    ...
    def collide(
        ...
        dx: float,
        dy: float,
        walls: List[Union[int, Tuple[int, int]]],
    ) -> Tuple[float, float]: ...
    def blt(
        self,
        x: float,
