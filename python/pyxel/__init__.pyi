...
class Seq(Generic[T]):
    ...
    def __setitem__(self, idx: Union[int, slice], value: Union[T, List[T]]) -> None: ...
...
def clamp(x: Union[int, float], lower: Union[int, float], upper: Union[int, float]) -> Union[int, float]: ...
