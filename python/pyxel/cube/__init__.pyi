...
# Contact class — engine-built collision payload for on_collide; not user-constructible, fields are read-only.
class Contact:
    @property
    def point(self) -> Vec3: ...
    @property
...
# RaycastHit class — engine-built payload returned by Node.raycast / raycast_all; not user-constructible, fields are read-only.
class RaycastHit:
    @property
    def node(self) -> Node: ...
    @property
