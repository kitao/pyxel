...
- `sounds`<br>
Lista bidimensionale di suoni (0-63) con il numero di canali da utilizzare.

- `set(*sounds)`<br>
Imposta le liste di suoni (0-63) dei canali da utilizzare. Se viene specificata una lista vuota, quel canale non viene utilizzato per la riproduzione.<br>
