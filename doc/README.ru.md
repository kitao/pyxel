...
- `sounds`<br>
Двумерный список звуков (0-63) с указанием количества используемых каналов.

- `set(*sounds)`<br>
Задайте списки звуковых (0-63) каналов, которые будут использоваться. Если указан пустой список, этот канал не используется для воспроизведения.<br>
